...
Background_image = pygame.transform.scale(pygame.image.load('Backround.png').convert(),(SCREEN_WIDTH, SCREEN_HEIGHT))
...
def game_loop():
    ...
    running = True
    while running:display_surface = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
